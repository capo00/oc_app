...
const Errors = require("../api/errors/app-finance-error.js");
...
const logger = LoggerFactory.get("AppFinanceAbl");
...
module.exports = new AppFinanceAbl();
