...
const Calls = {
  ...
  async importTransactions(dtoIn) {
    const commandUri = Calls.getCommandUri("transaction/import");
    const res = await Calls.call("post", commandUri, dtoIn);
    return res.data;
  },

  updateTransaction(dtoIn) {
